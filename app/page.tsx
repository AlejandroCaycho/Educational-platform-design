...
export default function Home() {
  ...
  return (
    <div className={`p-5 md:p-6 space-y-6 ${!showWelcome ? 'min-h-[calc(100vh-80px)] flex flex-col' : ''}`}>
      ...
      <div className={`grid grid-cols-1 lg:grid-cols-3 gap-6 ${!showWelcome ? 'flex-1' : ''}`}>
        {/* Performance Chart */}
        <div className={`bg-gradient-to-br from-card to-card/80 rounded-2xl border border-border/50 p-6 shadow-sm hover:shadow-md transition-shadow ${!showWelcome ? 'flex flex-col' : ''}`}>
          <div className="flex items-center gap-2 mb-4">
          ...
          <ResponsiveContainer width="100%" height={showWelcome ? 220 : !showWelcome ? '100%' : 250}>
